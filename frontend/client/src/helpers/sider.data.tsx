...
import { Create_post_icon, Explore_icon, Home_icon, Messages_icon, Reels_icon, Like_icon, Search_icon, Settings_icon, Saved_icon } from "../helpers/icons"
export const menu_categories = [
    ...
    { path: "/notifications", icon: <Like_icon />, label: "Уведомления" },
...
export const menu_categories = [
  ...
  { path: "/create_post", icon: <Create_post_icon />, label: "Создать" },
  {
    ...
    icon: (
      <Avatar
        src="https://uxwing.com/wp-content/themes/uxwing/download/business-professional-services/computer-user-icon.png"
        withBorder={true}
        size="xs"
        alt="#404"
      />
